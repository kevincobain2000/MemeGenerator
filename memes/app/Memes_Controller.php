...
require_once 'Memes_Error.php';
require_once 'Memes_ActionClass.php';
require_once 'Memes_ActionForm.php';
require_once 'Memes_ViewClass.php';

/**
 *  Memes application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Memes
 */
class Memes_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
    ...
    var $class = array(
        ...
        'form'          => 'Memes_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Memes_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Memes_UrlHandler',
    );
